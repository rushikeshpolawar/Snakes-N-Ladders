...
# intbg2=pygame.image.load("intropic1.jpg")
# intbg3=pygame.image.load("intropic1.jpg")
# intbg4=pygame.image.load("intropic1.jpg")
# intbg5=pygame.image.load("intropic1.jpg")
...
def turn(score,l,s):
    ...
    if score<=100:
        ...
        if lad!=score:
            ...
            score=lad 
        snk=snakes(score)
        if snk!=score: #checking for snakes for player Z
            s=True
            score=snk
